...
namespace termProjectWS
{
    ...
    public class MerchantStore : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public Boolean RegisterSite(String SiteID, String Description, String APIKey, String email,string password, string salt, object[] contactInfo)
        {
            ...
            else
            {
                ...
                regMerch.Parameters.Add(inputPassword);

                SqlParameter inputSalt = new SqlParameter("@salt", salt);

                inputSalt.Direction = ParameterDirection.Input;
                inputSalt.SqlDbType = SqlDbType.NVarChar;
                inputSalt.Size = 50;
                regMerch.Parameters.Add(inputSalt);
