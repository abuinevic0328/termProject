<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetMerchantPhone.aspx.cs" Inherits="termProject.ResetMerchantPhone" %>
...
<body>
    ...
    <div>
        ...
        <h3>
            <asp:Label ID="Label1" runat="server" Text="Change Merchant Phone Number"></asp:Label>
        </h3>
        ...
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" Text="Merchant Email:"></asp:Label>
        <br />
