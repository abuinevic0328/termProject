...
namespace termProject.MerchantStore {
    using System;
    ...
    public partial class MerchantStore : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public MerchantStore() {
            this.Url = global::termProject.Properties.Settings.Default.termProject_MerchantStore_MerchantStore;
        ...
        public bool RegisterSite(string SiteID, string Description, string APIKey, string email, string password, string salt, object[] contactInfo) {
        ...
        /// <remarks/>
        public void RegisterSiteAsync(string SiteID, string Description, string APIKey, string email, string password, string salt, object[] contactInfo) {
            this.RegisterSiteAsync(SiteID, Description, APIKey, email, password, salt, contactInfo, null);
        }
        
        /// <remarks/>
        public void RegisterSiteAsync(string SiteID, string Description, string APIKey, string email, string password, string salt, object[] contactInfo, object userState) {
