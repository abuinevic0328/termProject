...
namespace termProjectLibrary.MerchantStore {
    using System;
    ...
    public partial class MerchantStore : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public MerchantStore() {
            this.Url = global::termProjectLibrary.Properties.Settings.Default.termProjectLibrary_MerchantStore_MerchantStore;
        ...
        public bool RegisterSite(string SiteID, string Description, string APIKey, string email, object[] contactInfo) {
        ...
        /// <remarks/>
        public void RegisterSiteAsync(string SiteID, string Description, string APIKey, string email, object[] contactInfo) {
            this.RegisterSiteAsync(SiteID, Description, APIKey, email, contactInfo, null);
        }
        
        /// <remarks/>
        public void RegisterSiteAsync(string SiteID, string Description, string APIKey, string email, object[] contactInfo, object userState) {
